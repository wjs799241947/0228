...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
 ...
 <span id="date1">入住时间:</span>  <span id="date2">离开时间:</span>
				...
				<div class="banners">
					<div class="container">
						<div class="row">
							<div class="banner1 col-xs-12">
								<img alt="" src="img/1.png" id="index_png" style="width: 1300px;height: 400px;"/>
							</div>
						</div>
					</div>
				</div>
				<script>
					...
					function goBanner(){
						index ++;
						document.getElementById("index_png").src="img/"+index+".png";
						if(index>=4){
							index = 0;
						}
					}
					window.setInterval(goBanner,5000);
				</script>
				<div class="container" style="margin-top: 20px;">
					<div class="page-title category-title">
						<span style="font-size: 30px;font-weight: bold;">精品房源 &nbsp;&nbsp;</span><span style="font-size: 20px;">精装房!</span>
					</div>
					<div class="row">
						<div class="banner1 col-xs-12"> 
							<img alt="" src="img/top1.png" style="width: 1140px;height: 260px;"/>
						</div>
					</div>
					<!----diyihang chanpin -->
				...
				<div class="container" style="margin-top: 20px;">
					<div class="page-title category-title">
						<span style="font-size: 30px;font-weight: bold;">低价房 &nbsp;&nbsp;</span><span style="font-size: 20px;">便宜实惠</span>
					</div>
					<div class="row">
						<div class="banner1 col-xs-12">
							<img alt="" src="img/top2.jpg" style="width: 1140px;height: 260px;"/>
						</div>
					</div>
					<!----diyihang chanpin -->
					...
					<ul class="products-grid row"> 
					<c:forEach items="${houseList}" var="house" varStatus="status" begin="0" end="9" step="1">
					<c:if test="${house.price < 200}">
						<li class="item col-xs-3 first">
							<div class="product-container">
								<a href="" class="product-image">
									<img src="/file/${house.img}" /></a>
								<div class="product-shop">
									<h3 class="product-name"><a href="" title="JBL LSR4312SP 12 INCH SUBWOOFER">${house.title}
                            </a></h3>
				...
				<div class="container" style="margin-top: 20px;">
					<div class="page-title category-title">
						<span style="font-size: 30px;font-weight: bold;">同事聚餐 &nbsp;&nbsp;</span><span style="font-size: 20px;">小别墅!</span>
					</div>
					<div class="row">
						<div class="banner1 col-xs-12">
							<img alt="" src="img/top3.jpg" style="width: 1140px;height: 260px;" />
						</div>
					</div>
					<!----diyihang chanpin -->
					<ul class="products-grid row"> 
					<c:forEach items="${houseList}" var="house" varStatus="status" begin="0" end="30" step="1">
				...
				<div class="container" style="margin-top: 20px;">
					<div class="page-title category-title">
						<span style="font-size: 30px;font-weight: bold;">低奢 &nbsp;&nbsp;</span><span style="font-size: 20px;"> 享受生活!</span>
					</div>
					<div class="row">
						<div class="banner1 col-xs-12">
							<img alt="" src="img/top4.jpg" style="width: 1138px;height: 260px;" />
						</div>
					</div>
					<!----diyihang chanpin -->
					<ul class="products-grid row"> 
					<c:forEach items="${houseList}" var="house" varStatus="status" begin="0" end="30" step="1">
					<c:if test="${house.price > 1000}">
						<li class="item col-xs-3 first">
							<div class="product-container">
								<a href="" class="product-image">
									<img src="/file/${house.img}" style="width: 300px;height: 200px;"/></a>
